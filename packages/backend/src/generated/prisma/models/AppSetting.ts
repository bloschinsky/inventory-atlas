...
export type AppSettingWhereInput = {
  ...
  settingKey?: Prisma.StringFilter<"AppSetting"> | string
  valueText?: Prisma.StringFilter<"AppSetting"> | string
...
export type AppSettingScalarWhereWithAggregatesInput = {
  ...
  settingKey?: Prisma.StringWithAggregatesFilter<"AppSetting"> | string
  valueText?: Prisma.StringWithAggregatesFilter<"AppSetting"> | string
...
export type AppSettingOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"settingKey" | "valueText" | "updatedAt", ExtArgs["result"]["appSetting"]>
...
export interface AppSettingDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const appSettingWithSettingKeyOnly = await prisma.appSetting.findMany({ select: { settingKey: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many AppSettings and only return the `settingKey`
   * const appSettingWithSettingKeyOnly = await prisma.appSetting.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more AppSettings and only return the `settingKey`
   * const appSettingWithSettingKeyOnly = await prisma.appSetting.updateManyAndReturn({
   *   select: { settingKey: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface AppSettingFieldRefs {
  readonly settingKey: Prisma.FieldRef<"AppSetting", 'String'>
  readonly valueText: Prisma.FieldRef<"AppSetting", 'String'>
